...
const BannerCard = ({ bannerInfo }) => {
  return (
    <div
      className={`${styles.banner} ${bannerInfo.color} grid grid-cols-2 gap-5 relative z-1  md:rounded-xl p-11 before:absolute before:inset-0 before:opacity-5 before:bg-cover before:-z-1`}
    >
